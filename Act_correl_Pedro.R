...
#Ejercicio 1
#La correlación lineal es una medida estadística que describe la relación entre dos variables cuantitativas, esta
#indica la fuerza y dirección de la relación entre las variables, por ejemplo, cuando dos variables están positivamente correlacionadas, significa que aumentan o disminuyen juntas. 
#En cambio, si están negativamente correlacionadas, una variable aumenta mientras que la otra disminuye. 
#Una correlación de 1 indica una relación perfectamente positiva, -1 indica una relación perfectamente negativa y 0 indica ausencia de correlación.

#Ejercicio 2
#La correlación lineal se considera una prueba de correlación paramétrica porque asume que los datos siguen una distribución específica, 
#como la distribución normal. Las pruebas paramétricas, como la correlación lineal, requieren que los datos cumplan ciertos supuestos, como la normalidad y la homogeneidad de las varianzas. 
...
#La diagonal principal contendrá valores de correlación de 1, ya que representa la correlación de una variable consigo misma. 
#Los valores fuera de la diagonal principal mostrarán la correlación entre pares de variables.

#Ejercicio 4
resultados_corr <- corr.test(data)
corrplot(resultados_corr$r, method="circle", type="upper", sig.level=0.05, insig="blank")
#Este código calculará los coeficientes de correlación para todas las combinaciones de variables en tu conjunto de datos y mostrará un gráfico de correlación donde cada celda representará la correlación entre dos variables. 
...
#En este ejemplo, el primer gráfico muestra una relación lineal entre x y y_linear, donde los puntos de datos siguen una línea recta. 
#En el segundo gráfico, la relación entre x y y_monotonic es monótona, ya que los puntos de datos muestran un patrón de disminución constante, pero no necesariamente lineal.

#Ejercicio 10
#Cuando las variables experimentan una relación monótona, se puede aplicar la prueba de correlación de Spearman. 
#Esta prueba evalúa la fuerza y la dirección de la asociación entre dos variables, sin asumir que la relación es necesariamente lineal.
